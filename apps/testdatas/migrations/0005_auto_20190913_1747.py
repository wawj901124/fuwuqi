# Generated by Django 2.0.5 on 2019-09-13 17:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('testdatas', '0004_auto_20190909_1336'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_ele_find', models.CharField(default='xpath', help_text='元素查找风格：id、name、class_name、tag_name、link_text、partial_link_text、css_selector、xpath', max_length=100, verbose_name='输入框查找风格')),
                ('input_ele_find_value', models.CharField(default='', max_length=1000, verbose_name='输入框查找风格的确切值')),
                ('input_text', models.CharField(default='', max_length=300, verbose_name='输入框中要输入的内容')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': '新增选项框及选项内容',
                'verbose_name_plural': '新增选项框及选项内容',
            },
        ),
