# Generated by Django 2.0.5 on 2019-12-04 17:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db_database', models.CharField(blank=True, default='', max_length=100, null=True, verbose_name='数据库库名')),
                ('db_charset', models.CharField(blank=True, default='utf8', max_length=100, null=True, verbose_name='数据库编码格式')),
                ('db_biao', models.CharField(blank=True, default='', max_length=1000, null=True, verbose_name='数据库中的表')),
                ('db_ziduan', models.CharField(blank=True, default='', max_length=1000, null=True, verbose_name='数据库中的表的字段名')),
                ('db_xiugaiqiandezhi', models.CharField(blank=True, default='', max_length=1000, null=True, verbose_name='数据库中的表的字段修改前的值')),
                ('db_xiugaihoudezhi', models.CharField(blank=True, default='', max_length=1000, null=True, verbose_name='数据库中的表的字段修改后的值')),
                ('db_tiaojianziduan', models.CharField(blank=True, default='', max_length=100, null=True, verbose_name='where条件字段名')),
                ('db_tiaojianzhi', models.CharField(blank=True, default='', max_length=1000, null=True, verbose_name='where条件字段值')),
